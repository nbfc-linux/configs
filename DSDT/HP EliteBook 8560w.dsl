 ...
 */
DefinitionBlock ("", "DSDT", 2, "HPQOEM", "1631    ", 0x00000001)
{
    /*
     ...
     * required for each:
     */
    External (_GPE.VBRE, MethodObj)    // Warning: Unknown method, guessing 1 arguments
    External (_GPE.VLET, MethodObj)    // Warning: Unknown method, guessing 2 arguments
    External (_GPE.VPUP, MethodObj)    // Warning: Unknown method, guessing 3 arguments
    External (_PR_.CPU0._PPC, UnknownObj)
    External (_PR_.CPU0._PSS, IntObj)
    External (_SB_.BEVT, UnknownObj)
    External (_SB_.F4EV, UnknownObj)
    External (_SB_.VWAK, MethodObj)    // Warning: Unknown method, guessing 1 arguments
    External (_SB_.WBRT, MethodObj)    // Warning: Unknown method, guessing 0 arguments
    External (CFGD, UnknownObj)
    External (DIDM, IntObj)
    ...
    External (VBRE, MethodObj)    // Warning: Unknown method, guessing 1 arguments
    External (VDET, MethodObj)    // Warning: Unknown method, guessing 1 arguments
    External (VFN4, MethodObj)    // Warning: Unknown method, guessing 0 arguments
    External (VGDD, IntObj)
    External (VSDD, UnknownObj)
    ...
    OperationRegion (GNVS, SystemMemory, 0xBF7AAB98, 0x019F)
    ...
    OperationRegion (ASMA, SystemMemory, 0xBF7A8018, 0x1060)
    Field (ASMA, AnyAcc, NoLock, Preserve)
    {
        ASMB,   33536
    }

    OperationRegion (AF10, SystemMemory, 0xBF7AA018, 0x0B58)
    ...
    OperationRegion (HPDF, SystemMemory, 0xBF7ABE18, 0x017C)
    ...
    OperationRegion (HPD2, SystemMemory, 0xBF649F18, 0x006D)
    ...
    OperationRegion (HPBR, SystemMemory, 0xBF7A7F18, 0x007E)
        ...
        Device (PCI0)
        {
            ...
            Device (PEGP.DGFX)
            {
                ...
                Method (NDOD, 0, NotSerialized)
                {
                    If ((DODC == 0x00))
                    {
                        Local0 = DIDM /* External reference */
                        DODS [0x00] = DerefOf (Local0 [0x00])
                        DODC = 0x01
                    }
            ...
            Device (LPCB)
            {
                ...
                Device (EC0)
                {
                    ...
                    {
                        \_SB.PCI0.ACEL.AJAL () = \_GPE.VLET (Local4, Notify (\_SB.LID, 0x80) // Status Change)
        ...
        Device (AC)
        {
            ...
            Method (_PSR, 0, NotSerialized)  // _PSR: Power Source
            {
                ...
                If ((Local0 ^ ACST))
                {
                    \_GPE.HNLP (0x00)
                    \_SB.PCI0.ACEL.AJAL ()
                    \_GPE.VPUP (Local0, Local1, \_SB.PCI0.LPCB.EC0.SMCP (Local0))
                }
