...
DefinitionBlock ("", "DSDT", 2, "_ASUS_", "Notebook", 0x01072009)
{
    ...
    External (_SB_.PCI0.GPP0.PEGP.WAT2, MethodObj)    // 0 Arguments
    External (_SB_.PCI0.SBRG.EC0_.DPHP, UnknownObj)
    External (_SB_.PCI0.SBRG.EC0_.ECOK, IntObj)
    External (_SB_.PCI0.SBRG.EC0_.MUT0, MutexObj)
    External (_SB_.PCI0.SBRG.EC0_.NVON, MethodObj)    // 0 Arguments
    External (_SB_.PCI0.SBRG.EC0_.SKEY, MethodObj)    // 1 Arguments
    External (_SB_.PCI0.SBRG.EC0_.UMAF, UnknownObj)
    External (_SB_.PCI0.SBRG.EC0_.UMCF, UnknownObj)
    External (_SB_.PCI0.SBRG.EC0_.UMOE, UnknownObj)
    ...
    Name (DTPT, Zero)
    Name (TTDP, One)
    Name (TPMB, 0xEC3AA000)
    Name (TPBS, 0x4000)
    Name (TPMC, 0xEC3AE000)
    Name (TPCS, 0x4000)
    Name (TPMM, 0xFD210510)
    Name (FTPM, 0xFD210510)
    Name (PPIM, 0xEC75AC98)
    Name (PPIL, 0x1C)
    Name (AMDT, One)
    Name (TPMF, One)
    Name (PPIV, One)
    ...
    Name (VGAF, One)
    OperationRegion (GNVS, SystemMemory, 0xEC75AB18, 0x0C)
    ...
    Method (SPTS, 1, NotSerialized)
    {
        ...
        If ((Arg0 == 0x04))
        {
            SLPS = One
            RSTU = One
            If ((\_SB.PCI0.SBRG.EC0.UMAF == Zero))
            {
        ...
        Device (PCI0)
        {
            ...
            Device (GPP4)
            {
                ...
                PowerResource (WRST, 0x05, 0x0000)
                {
                    Method (_STA, 0, NotSerialized)  // _STA: Status
                    {
                        Return (WPLS) /* \_SB_.PCI0.GPP4.WPLS */
                    }
    ...
    OperationRegion (EXBU, SystemMemory, 0xEC75AC18, 0x0050)
    ...
    Scope (_SB.PCI0.SBRG)
    {
        Device (EC0)
        {
            ...
            Method (_Q60, 0, NotSerialized)  // _Qxx: EC Query, xx=0x00-0xFF
            {
                ...
                Sleep (0x14)
                M255 = 0x03
                M256 = CHTF /* \_SB_.PCI0.SBRG.EC0_.CHTF */
                ALIB (0x0C, UTDP)
                Sleep (0x64)
                Sleep (0x32)
            }
            ...
            If ((Local0 == 0x53564544))
            {
                ...
                If ((IIA0 == 0x00090020))
                {
                    ...
                    If ((IIA1 == One))
                    {
                        ...
                        If ((^^PCI0.SBRG.EC0.UMAF == One))
                        {
                            ^^PCI0.SBRG.EC0.UMCF = One
                            ^^PCI0.SBRG.EC0.UMAF = One
                        }
                    }
                    Else
                    {
                        If ((^^PCI0.SBRG.EC0.UMCF == One))
                        {
                            ^^PCI0.SBRG.EC0.UMCF = Zero
                            ^^PCI0.SBRG.EC0.UMOE = Zero
                            ^^PCI0.SBRG.EC0.UMAF = Zero
                            UMFG = Zero
                            ^^PCI0.SBRG.EC0.NVON ()
                            Notify (^^PCI0.GPP0.PEGP, Zero) // Bus Check
                            ^^PCI0.SBRG.EC0.QA4F = One
            ...
            Device (WLAN)
            {
                ...
                If ((^^SBRG.EC0.SARF == One))
                {
                    ...
                    Method (EWRD, 0, Serialized)
                    {
                        ...
                        Return (EWRY) /* \_SB_.PCI0.GPP4.WLAN.EWRD.EWRY */
                    }
                    ...
                    Method (WGDS, 0, Serialized)
                    {
                        ...
                        Return (WGDY) /* \_SB_.PCI0.GPP4.WLAN.WGDS.WGDY */
                    }
                }
                Else
                {
